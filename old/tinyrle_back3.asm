...
align 4
_start:
	; data is 1024 long at rbp - 1024
	; output is 1280 long (worst-case output length) at rbp - 2304
	mov rbp, rsp				; mark bottom of stack
	sub rsp, 2304				; 1kb buffer + 1280b buffer
read_loop:
	xor rax, rax				; read
	mov rdi, rax				; fd = stdin
	mov rdx, 1024				; buffer is 1kb
	mov rsi, rbp				; buffer is at rbp - 1024
	sub rsi, rdx
	syscall
